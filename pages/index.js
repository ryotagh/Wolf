...
.ptag{font-size:.54px;padding:2px 4px;border-radius:6px;margin-top:2px;display:inline-block}
.ty{background:rgba(51,102,200,.3);color:#88aaff}.ta{background:rgba(70,70,70,.3);color:#aaa}
